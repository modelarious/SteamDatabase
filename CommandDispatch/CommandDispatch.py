...
class CommandDispatch:
    def __init__(self, command_socket_fetch_function: Callable[[], SocketWrapper], input_socket_fetch_function: Callable[[], SocketWrapper], command_factory: CommandFactory):
    ...
    def command_loop(self):
        while True:
            ...
            command = self.command_factory.create(message, self.input_socket_fetch_function)
