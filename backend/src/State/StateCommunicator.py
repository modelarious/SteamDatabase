...
class StateCommunicator(StateCommunicatorInterface):
    def __init__(
        self,
        observedDataStructures: Dict[StateStrType, ObservedDataStructure],
        games_observable_data_structure: ObservedDataStructure,
    ):
        ...
        self.queuedForInfoRetrieval = observedDataStructures[
