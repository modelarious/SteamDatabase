from ExternalDataFetchers.AppDetails import AppDetails


class Game:
    def __init__(self, steam_id, name_on_harddrive, path_on_harddrive, name_on_steam, avg_review_score, user_defined_genres, app_details : AppDetails):
