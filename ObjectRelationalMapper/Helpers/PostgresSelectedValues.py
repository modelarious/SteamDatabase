...
class PostgresSelectedValues:
    ...
    def gather_and_store(
        self, ORMClass: Type[ORMAbstractBase], orm_instances: List[ORMAbstractBase]
    ):
    ...
    def get_associated_data(
        self,
        ORMClass: Type[ORMAbstractBase],
        steam_id: int,
        default_value: Optional[Any] = None,
    ) -> Dict[int, Union[ORMAbstractBase, List[ORMAbstractBase]]]:
        try:
    ...
    def _array_handler(
        self, orm_instances: List[ORMAbstractBase]
    ) -> Dict[int, List[ORMAbstractBase]]:
        gathered_values = {}
        ...
        try:
            orm_instances_internal = sorted(
                orm_instances, key=lambda orm_instance: orm_instance.rank
            )
        except:
            pass
    ...
    def _unique_value_handler(
        self, orm_instances: List[ORMAbstractBase]
    ) -> Dict[int, ORMAbstractBase]:
        gathered_values = {}
    ...
    def _group_values(
        self, ORMClass: Type[ORMAbstractBase], data_to_group: List[ORMAbstractBase]
    ):
